...
The data used in the analysis comes from the Fraser Institute on World Economics. Researchers at the Institute assign a score from 0-10 under 5 different categories: Size of government, legal system and security of property rights, sound money, freedom to trade internationally, and regulation. The dependent variable is the composite measure of economic freedom,the Economic Freedom Index, encompassing aspects of trade openness, property rights, and monetary policy. The independent variable is government size, which is measured through aspects such as government expenditures and taxes. Along with this, the regulation variable, which I will also test as an independent variable, assesses financial regulations and competition laws. A higher score on regulation 

Data will be measured through a scatter plot model and a correlation will be derived. Through two scatter plots comparing independent variables government size and regulation to the efi,  I hope to observe a strong negative correlation between government size and economic freedom, as this would prove my hypothesis, and a strong positive correlation between regulation and economic freedom.

The data are cross sectional and analyzes countries at one point in time. 
