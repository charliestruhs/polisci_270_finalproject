...
Because I am measuring a population and do not require a random sample and hypothesis test generation, I am confident in the results of the correlation calculation as well as the graph data. However, were we to only have a sample of the data, a hypothesis test could be run to calculate the population value. In this case, all the data is here and a hypothesis test on the sum of the data would not be useful and simply wrong to perform on this study. 